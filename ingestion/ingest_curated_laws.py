"""CLI entrypoint for curated milestone-2 law ingestion."""
...
from ingestion.curated_ingestion import run_curated_law_ingestion


def parse_args() -> argparse.Namespace:
    """Parse CLI arguments."""
    parser = argparse.ArgumentParser(description="Ingest curated BWB law seeds.")
...
def main() -> int:
    """Run curated law ingestion and print a concise summary."""
    args = parse_args()
